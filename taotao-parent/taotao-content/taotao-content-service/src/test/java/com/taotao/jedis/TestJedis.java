...
//		Jedis jedis = new Jedis("192.168.156.60", 6379);
//		//直接操作数据库
...
//		//向集合中添加节点
//		nodes.add(new HostAndPort("192.168.156.60", 7001));
//		nodes.add(new HostAndPort("192.168.156.60", 7002));
//		nodes.add(new HostAndPort("192.168.156.60", 7003));
//		nodes.add(new HostAndPort("192.168.156.60", 7004));
//		nodes.add(new HostAndPort("192.168.156.60", 7005));
//		nodes.add(new HostAndPort("192.168.156.60", 7006));
//		//创建JedisCluster对象
